                            ...
                            child: GestureDetector(
                              onDoubleTap: () {
                                if (_usrnameController.text.isNotEmpty) {
                                  _usrnameController.selection = TextSelection(
                                      baseOffset: 0,
                                      extentOffset:
                              ...
                              child: TextFormField(
                                ...
                                decoration: InputDecoration(
                                  ...
                                  focusedBorder: OutlineInputBorder(
                                    borderSide:
                                        const BorderSide(color: C.infoDefault),
                                ...
                                if (_retypepwdController.text.isNotEmpty) {
                                  _retypepwdController.selection =
                                      TextSelection(
                                          baseOffset: 0,
                                          extentOffset:
                                              _retypepwdController.text.length);
                                }
                              },
                              child: TextFormField(
